...
public class Document extends DocumentMetaData {
    ...
    public String getUser() {
        if (Document_Type.featOkTst && ((Document_Type) jcasType).casFeat_user == null)
            jcasType.jcas.throwFeatMissing("user", "org.texttechnologylab.annotation.administration.Document");
        return jcasType.ll_cas.ll_getStringValue(addr, ((Document_Type) jcasType).casFeatCode_user);
    }
    ...
    public void setUser(String v) {
        if (Document_Type.featOkTst && ((Document_Type) jcasType).casFeat_user == null)
            jcasType.jcas.throwFeatMissing("user", "org.texttechnologylab.annotation.administration.Document");
        jcasType.ll_cas.ll_setStringValue(addr, ((Document_Type) jcasType).casFeatCode_user, v);
    }
}
