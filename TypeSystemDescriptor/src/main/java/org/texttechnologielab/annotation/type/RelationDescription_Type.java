...
public class RelationDescription_Type extends Attribute_Type {
     ...
     */
    @SuppressWarnings("hiding")
    public final static boolean featOkTst = JCasRegistry.getFeatOkTst("org.texttechnologielab.annotation.type.RelationDescription");
    ...
    public String getName(int addr) {
        if (featOkTst && casFeat_name == null)
            jcas.throwFeatMissing("name", "org.texttechnologielab.annotation.type.RelationDescription");
    ...
    public String getRelationtype(int addr) {
        if (featOkTst && casFeat_relationtype == null)
            jcas.throwFeatMissing("relationtype", "org.texttechnologielab.annotation.type.RelationDescription");
