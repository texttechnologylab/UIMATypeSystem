...
public class GraphBase_Type extends AnnotationBase_Type {
     ...
     */
    @SuppressWarnings("hiding")
    public final static boolean featOkTst = JCasRegistry.getFeatOkTst("org.texttechnologielab.annotation.type.GraphBase");
    ...
    public String getId(int addr) {
        if (featOkTst && casFeat_Id == null)
            jcas.throwFeatMissing("Id", "org.texttechnologielab.annotation.type.GraphBase");
    ...
    public String getLabel(int addr) {
        if (featOkTst && casFeat_label == null)
            jcas.throwFeatMissing("label", "org.texttechnologielab.annotation.type.GraphBase");
    ...
    public long getCreate(int addr) {
        if (featOkTst && casFeat_create == null)
            jcas.throwFeatMissing("create", "org.texttechnologielab.annotation.type.GraphBase");
    ...
    public long getModified(int addr) {
        if (featOkTst && casFeat_modified == null)
            jcas.throwFeatMissing("modified", "org.texttechnologielab.annotation.type.GraphBase");
    ...
    public String getUser(int addr) {
        if (featOkTst && casFeat_user == null)
            jcas.throwFeatMissing("user", "org.texttechnologielab.annotation.type.GraphBase");
