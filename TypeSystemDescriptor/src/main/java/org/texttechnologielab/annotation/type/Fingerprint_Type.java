...
public class Fingerprint_Type extends Node_Type {
     ...
     */
    @SuppressWarnings("hiding")
    public final static boolean featOkTst = JCasRegistry.getFeatOkTst("org.texttechnologielab.annotation.type.Fingerprint");
    ...
    public String getUser(int addr) {
        if (featOkTst && casFeat_user == null)
            jcas.throwFeatMissing("user", "org.texttechnologielab.annotation.type.Fingerprint");
    ...
    public long getCreate(int addr) {
        if (featOkTst && casFeat_create == null)
            jcas.throwFeatMissing("create", "org.texttechnologielab.annotation.type.Fingerprint");
    ...
    public int getReference(int addr) {
        if (featOkTst && casFeat_reference == null)
            jcas.throwFeatMissing("reference", "org.texttechnologielab.annotation.type.Fingerprint");
