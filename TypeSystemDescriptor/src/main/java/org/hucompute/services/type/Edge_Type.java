...
public class Edge_Type extends GraphBase_Type {
     ...
     */
    @SuppressWarnings("hiding")
    public final static boolean featOkTst = JCasRegistry.getFeatOkTst("org.hucompute.services.type.Edge");
    ...
    public int getSource(int addr) {
        if (featOkTst && casFeat_source == null)
            jcas.throwFeatMissing("source", "org.hucompute.services.type.Edge");
    ...
    public int getTarget(int addr) {
        if (featOkTst && casFeat_target == null)
            jcas.throwFeatMissing("target", "org.hucompute.services.type.Edge");
    ...
    public int getAttribute(int addr) {
        if (featOkTst && casFeat_attribute == null)
            jcas.throwFeatMissing("attribute", "org.hucompute.services.type.Edge");
    ...
    public String getEdgetype(int addr) {
        if (featOkTst && casFeat_edgetype == null)
            jcas.throwFeatMissing("edgetype", "org.hucompute.services.type.Edge");
    ...
    public Edge_Type(JCas jcas, Type casType) {
        ...
        casFeat_source = jcas.getRequiredFeatureDE(casType, "source", "org.hucompute.services.type.Node", featOkTst);
        casFeatCode_source = (null == casFeat_source) ? JCas.INVALID_FEATURE_CODE : ((FeatureImpl) casFeat_source).getCode();


        casFeat_target = jcas.getRequiredFeatureDE(casType, "target", "org.hucompute.services.type.Node", featOkTst);
