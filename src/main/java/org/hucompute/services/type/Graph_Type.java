...
public class Graph_Type extends Node_Type {
     ...
     */
    @SuppressWarnings("hiding")
    public final static boolean featOkTst = JCasRegistry.getFeatOkTst("org.hucompute.services.type.Graph");
    ...
    public int getNodes(int addr) {
        if (featOkTst && casFeat_nodes == null)
            jcas.throwFeatMissing("nodes", "org.hucompute.services.type.Graph");
    ...
    public int getEdges(int addr) {
        if (featOkTst && casFeat_edges == null)
            jcas.throwFeatMissing("edges", "org.hucompute.services.type.Graph");
