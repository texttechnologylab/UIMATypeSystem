...
public class Edge extends GraphBase {
    ...
    public Node getSource() {
        if (Edge_Type.featOkTst && ((Edge_Type) jcasType).casFeat_source == null)
            jcasType.jcas.throwFeatMissing("source", "org.hucompute.services.type.Edge");
    ...
    public Node getTarget() {
        if (Edge_Type.featOkTst && ((Edge_Type) jcasType).casFeat_target == null)
            jcasType.jcas.throwFeatMissing("target", "org.hucompute.services.type.Edge");
    ...
    public Attribute getAttribute() {
        if (Edge_Type.featOkTst && ((Edge_Type) jcasType).casFeat_attribute == null)
            jcasType.jcas.throwFeatMissing("attribute", "org.hucompute.services.type.Edge");
    ...
    public String getEdgetype() {
        if (Edge_Type.featOkTst && ((Edge_Type) jcasType).casFeat_edgetype == null)
            jcasType.jcas.throwFeatMissing("edgetype", "org.hucompute.services.type.Edge");
