...
public class RelationSet_Type extends AnnotationBase_Type {
     ...
     */
    @SuppressWarnings("hiding")
    public final static boolean featOkTst = JCasRegistry.getFeatOkTst("org.hucompute.services.type.RelationSet");
    ...
    public int getRelations(int addr) {
        if (featOkTst && casFeat_relations == null)
            jcas.throwFeatMissing("relations", "org.hucompute.services.type.RelationSet");
