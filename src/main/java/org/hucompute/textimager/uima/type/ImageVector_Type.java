...
public class ImageVector_Type extends Annotation_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("org.hucompute.textimager.uima.type.ImageVector");
  ...
  public int getEmbedding(int addr) {
      ...
      jcas.throwFeatMissing("embedding", "org.hucompute.textimager.uima.type.ImageVector");
  ...
  public String getValue(int addr) {
      ...
      jcas.throwFeatMissing("value", "org.hucompute.textimager.uima.type.ImageVector");
