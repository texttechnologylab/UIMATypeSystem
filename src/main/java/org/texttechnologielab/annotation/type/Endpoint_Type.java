...
public class Endpoint_Type extends GraphBase_Type {
     ...
     */
    @SuppressWarnings("hiding")
    public final static boolean featOkTst = JCasRegistry.getFeatOkTst("org.texttechnologielab.annotation.type.Endpoint");
    ...
    public int getNode(int addr) {
        if (featOkTst && casFeat_node == null)
            jcas.throwFeatMissing("node", "org.texttechnologielab.annotation.type.Endpoint");
    ...
    public Endpoint_Type(JCas jcas, Type casType) {
        ...
        casFeat_node = jcas.getRequiredFeatureDE(casType, "node", "org.texttechnologielab.annotation.type.Node", featOkTst);
