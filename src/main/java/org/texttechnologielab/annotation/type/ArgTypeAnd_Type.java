...
public class ArgTypeAnd_Type extends ArgType_Type {
     ...
     */
    @SuppressWarnings("hiding")
    public final static boolean featOkTst = JCasRegistry.getFeatOkTst("org.texttechnologielab.annotation.type.ArgTypeAnd");
    ...
    public int getData2(int addr) {
        if (featOkTst && casFeat_data2 == null)
            jcas.throwFeatMissing("data2", "org.texttechnologielab.annotation.type.ArgTypeAnd");
