 ...
 * @generated
 */
public class Above_Type extends OrientationEdge_Type {
    /**
     * @generated
     */
    @SuppressWarnings("hiding")
    public final static int typeIndexID = Above.typeIndexID;
    /**
     * @generated
     * @modifiable
     */
    @SuppressWarnings("hiding")
    public final static boolean featOkTst = JCasRegistry.getFeatOkTst("org.texttechnologielab.annotation.orientation.type.Above");
     ...
     * @generated
     */
    public Above_Type(JCas jcas, Type casType) {
        super(jcas, casType);
