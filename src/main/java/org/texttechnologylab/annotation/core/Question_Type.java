...
public class Question_Type extends Annotation_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("org.texttechnologylab.annotation.core.Question");
  ...
  public String getKey(int addr) {
      ...
      jcas.throwFeatMissing("key", "org.texttechnologylab.annotation.core.Question");
  ...
  public String getDescription(int addr) {
      ...
      jcas.throwFeatMissing("description", "org.texttechnologylab.annotation.core.Question");
