 ...
 * @generated */
public class SentimentModel_Type extends SentimentBert_Type {
  /** @generated */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = SentimentModel.typeIndexID;
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("org.texttechnologylab.annotation.SentimentModel");
  ...
  public int getModel(int addr) {
      ...
      jcas.throwFeatMissing("model", "org.texttechnologylab.annotation.SentimentModel");
  ...
  /** initialize variables to correspond with Cas Type and Features
	 ...
	 * @param casType Type 
	 */
  public SentimentModel_Type(JCas jcas, Type casType) {
    super(jcas, casType);
