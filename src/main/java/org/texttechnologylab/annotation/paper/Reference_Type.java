 ...
 * @generated */
public class Reference_Type extends NonTextContent_Type {
  /** @generated */
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("org.texttechnologylab.annotation.paper.Reference");
  ...
  public int getReference(int addr) {
      ...
      jcas.throwFeatMissing("reference", "org.texttechnologylab.annotation.paper.Reference");
