...
public class Keyword_Type extends Annotation_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("org.texttechnologylab.annotation.paper.Keyword");
  ...
  public String getValue(int addr) {
      ...
      jcas.throwFeatMissing("value", "org.texttechnologylab.annotation.paper.Keyword");
