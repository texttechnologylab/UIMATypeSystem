 ...
 * @generated */
public class Footnote_Type extends TextContent_Type {
  /** @generated */
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("org.texttechnologylab.annotation.paper.Footnote");
  ...
  public int getReference(int addr) {
      ...
      jcas.throwFeatMissing("reference", "org.texttechnologylab.annotation.paper.Footnote");
