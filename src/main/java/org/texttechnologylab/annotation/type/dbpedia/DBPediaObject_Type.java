...
public class DBPediaObject_Type extends Annotation_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("org.texttechnologylab.annotation.type.dbpedia.DBPediaObject");
  ...
  public double getSimilarityScore(int addr) {
      ...
      jcas.throwFeatMissing("similarityScore", "org.texttechnologylab.annotation.type.dbpedia.DBPediaObject");
  ...
  public double getPercentageOfSecondRank(int addr) {
      ...
      jcas.throwFeatMissing("percentageOfSecondRank", "org.texttechnologylab.annotation.type.dbpedia.DBPediaObject");
  ...
  public String getUri(int addr) {
      ...
      jcas.throwFeatMissing("uri", "org.texttechnologylab.annotation.type.dbpedia.DBPediaObject");
  ...
  public int getTypes(int addr) {
      ...
      jcas.throwFeatMissing("types", "org.texttechnologylab.annotation.type.dbpedia.DBPediaObject");
