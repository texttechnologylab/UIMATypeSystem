...
public class MultimediaElement extends Annotation {
  ...
  */  
   ...
   */
  public float getTimeStart() { return _getFloatValueNc(wrapGetIntCatchException(_FH_timeStart));}
   ...
   * @return value of the feature 
   */
  public float getTimeEnd() { return _getFloatValueNc(wrapGetIntCatchException(_FH_timeEnd));}
