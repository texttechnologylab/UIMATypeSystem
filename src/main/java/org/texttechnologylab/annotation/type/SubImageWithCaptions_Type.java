 ...
 * @generated */
public class SubImageWithCaptions_Type extends SubImage_Type {
  /** @generated */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = SubImageWithCaptions.typeIndexID;
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("org.texttechnologylab.annotation.type.SubImageWithCaptions");
  ...
  public int getCaptions(int addr) {
      ...
      jcas.throwFeatMissing("captions", "org.texttechnologylab.annotation.type.SubImageWithCaptions");
  ...
  public String getCaptionLanguage(int addr) {
      ...
      jcas.throwFeatMissing("captionLanguage", "org.texttechnologylab.annotation.type.SubImageWithCaptions");
  ...
  /** initialize variables to correspond with Cas Type and Features
	 ...
	 * @param casType Type 
	 */
  public SubImageWithCaptions_Type(JCas jcas, Type casType) {
    super(jcas, casType);
