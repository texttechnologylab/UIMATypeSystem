...
public class Weight_Type extends Attribute_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("org.texttechnologylab.annotation.type.Weight");
  ...
  public double getValue(int addr) {
      ...
      jcas.throwFeatMissing("value", "org.texttechnologylab.annotation.type.Weight");
