...
public class ArgTypeOr_Type extends ArgType_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("org.texttechnologylab.annotation.type.ArgTypeOr");
  ...
  public int getData2(int addr) {
      ...
      jcas.throwFeatMissing("data2", "org.texttechnologylab.annotation.type.ArgTypeOr");
