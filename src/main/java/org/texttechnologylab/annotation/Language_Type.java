...
public class Language_Type extends Annotation_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("org.texttechnologylab.annotation.Language");
  ...
  public String getValue(int addr) {
      ...
      jcas.throwFeatMissing("value", "org.texttechnologylab.annotation.Language");
  ...
  public double getScore(int addr) {
      ...
      jcas.throwFeatMissing("score", "org.texttechnologylab.annotation.Language");
