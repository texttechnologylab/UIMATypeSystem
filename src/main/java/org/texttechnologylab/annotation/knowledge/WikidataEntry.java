...
public class WikidataEntry extends KnowledgeEntry {
  ...
  */  
   ...
   */
  public StringList getP31() { return (StringList)(_getFeatureValueNc(wrapGetIntCatchException(_FH_P31)));}
   ...
   * @return value of the feature 
   */
  public StringList getP279() { return (StringList)(_getFeatureValueNc(wrapGetIntCatchException(_FH_P279)));}
