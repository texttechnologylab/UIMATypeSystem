...
public class Annotation extends org.apache.uima.jcas.tcas.Annotation {
  ...
  public final static String _TypeName = "org.texttechnologylab.annotation.annis.Annotation";
  ...
  private final static CallSite _FC_value = TypeSystemImpl.createCallSite(Annotation.class, "value");
   ...
   */
  public Annotation(TypeImpl type, CASImpl casImpl) {
    super(type, casImpl);
    readObject();
  }
