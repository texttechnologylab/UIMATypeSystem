...
public class StructuralElement_Type extends Div_Type {
  ...
  public final static int typeIndexID = StructuralElement.typeIndexID;
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("org.texttechnologylab.annotation.ocr.abbyy.StructuralElement");
  ...
  public int getTop(int addr) {
      ...
      jcas.throwFeatMissing("top", "org.texttechnologylab.annotation.ocr.abbyy.StructuralElement");
  ...
  public int getBottom(int addr) {
      ...
      jcas.throwFeatMissing("bottom", "org.texttechnologylab.annotation.ocr.abbyy.StructuralElement");
  ...
  public int getLeft(int addr) {
      ...
      jcas.throwFeatMissing("left", "org.texttechnologylab.annotation.ocr.abbyy.StructuralElement");
  ...
  public int getRight(int addr) {
      ...
      jcas.throwFeatMissing("right", "org.texttechnologylab.annotation.ocr.abbyy.StructuralElement");
  ...
  /** initialize variables to correspond with Cas Type and Features
	 ...
	 * @param casType Type 
	 */
  public StructuralElement_Type(JCas jcas, Type casType) {
    super(jcas, casType);
