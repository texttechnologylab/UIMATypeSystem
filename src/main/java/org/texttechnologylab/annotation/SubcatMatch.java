...
public class SubcatMatch extends AnnotationBase {
   ...
   */
  public String getStatus() { return _getStringValueNc(wrapGetIntCatchException(_FH_status));}
  ...
  public SemanticSource getElements(int i) {
     return (SemanticSource)(((FSArray)(_getFeatureValueNc(wrapGetIntCatchException(_FH_elements)))).get(i));} 
