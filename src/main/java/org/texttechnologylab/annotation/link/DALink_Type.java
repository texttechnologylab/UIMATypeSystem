 ...
 * @generated */
public class DALink_Type extends Link_Type {
  /** @generated */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = DALink.typeIndexID;
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("org.texttechnologylab.annotation.link.DALink");
  ...
  public String getFrom(int addr) {
      ...
      jcas.throwFeatMissing("from", "org.texttechnologylab.annotation.link.DALink");
  ...
  public int getTo(int addr) {
      ...
      jcas.throwFeatMissing("to", "org.texttechnologylab.annotation.link.DALink");
  ...
  /** initialize variables to correspond with Cas Type and Features
	 ...
	 * @param casType Type 
	 */
  public DALink_Type(JCas jcas, Type casType) {
    super(jcas, casType);
    ...
    casFeat_to = jcas.getRequiredFeatureDE(casType, "to", "uima.tcas.Annotation", featOkTst);
