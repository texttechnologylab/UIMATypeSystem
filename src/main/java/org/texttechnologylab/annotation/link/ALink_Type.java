...
public class ALink_Type extends Link_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("org.texttechnologylab.annotation.link.ALink");
  ...
  public int getFrom(int addr) {
      ...
      jcas.throwFeatMissing("from", "org.texttechnologylab.annotation.link.ALink");
  ...
  public int getTo(int addr) {
      ...
      jcas.throwFeatMissing("to", "org.texttechnologylab.annotation.link.ALink");
