 ...
 * @generated */
public class MetaDataKeyValue_Type extends TOP_Type {
  /** @generated */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = MetaDataKeyValue.typeIndexID;
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("org.texttechnologylab.annotation.biofid.gnfinder.MetaDataKeyValue");
  ...
  public String getKey(int addr) {
      ...
      jcas.throwFeatMissing("key", "org.texttechnologylab.annotation.biofid.gnfinder.MetaDataKeyValue");
  ...
  public String getValue(int addr) {
      ...
      jcas.throwFeatMissing("value", "org.texttechnologylab.annotation.biofid.gnfinder.MetaDataKeyValue");
  ...
  /** initialize variables to correspond with Cas Type and Features
	 ...
	 * @param casType Type 
	 */
  public MetaDataKeyValue_Type(JCas jcas, Type casType) {
    super(jcas, casType);
