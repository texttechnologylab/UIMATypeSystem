...
public class Genre extends Annotation {
  ...
  */  
   ...
   */
  public FSArray getGenres() { return (FSArray)(_getFeatureValueNc(wrapGetIntCatchException(_FH_Genres)));}
  ...
  public AnnotationComment getGenres(int i) {
     return (AnnotationComment)(((FSArray)(_getFeatureValueNc(wrapGetIntCatchException(_FH_Genres)))).get(i));} 
  ...
  public void setGenres(int i, AnnotationComment v) {
    ((FSArray)(_getFeatureValueNc(wrapGetIntCatchException(_FH_Genres)))).set(i, v);
  }  
