...
public class AnnotationAttribute_Type extends AnnotationBase_Type {
  ...
  public final static int typeIndexID = AnnotationAttribute.typeIndexID;
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("org.texttechnologylab.annotation.schema.AnnotationAttribute");
  ...
  public int getKey(int addr) {
      ...
      jcas.throwFeatMissing("key", "org.texttechnologylab.annotation.schema.AnnotationAttribute");
  ...
  /** initialize variables to correspond with Cas Type and Features
	 ...
	 * @param casType Type 
	 */
  public AnnotationAttribute_Type(JCas jcas, Type casType) {
    super(jcas, casType);
    casImpl.getFSClassRegistry().addGeneratorForType((TypeImpl)this.casType, getFSGenerator());

 
    casFeat_key = jcas.getRequiredFeatureDE(casType, "key", "org.texttechnologylab.annotation.schema.Attribute", featOkTst);
