...
public class AnnotationLink_Type extends Annotation_Type {
  ...
  public final static int typeIndexID = AnnotationLink.typeIndexID;
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("org.texttechnologylab.annotation.schema.AnnotationLink");
  ...
  public int getReference(int addr) {
      ...
      jcas.throwFeatMissing("reference", "org.texttechnologylab.annotation.schema.AnnotationLink");
  ...
  /** initialize variables to correspond with Cas Type and Features
	 ...
	 * @param casType Type 
	 */
  public AnnotationLink_Type(JCas jcas, Type casType) {
    super(jcas, casType);
