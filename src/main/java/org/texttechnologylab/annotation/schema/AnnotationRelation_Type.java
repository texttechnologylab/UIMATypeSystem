 ...
 * @generated */
public class AnnotationRelation_Type extends AnnotationAttribute_Type {
  /** @generated */
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("org.texttechnologylab.annotation.schema.AnnotationRelation");
  ...
  public int getAttributes(int addr) {
      ...
      jcas.throwFeatMissing("attributes", "org.texttechnologylab.annotation.schema.AnnotationRelation");
