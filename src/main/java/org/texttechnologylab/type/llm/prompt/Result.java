...
public class Result extends Annotation {
  ...
  */  
   ...
   * @return value of the feature 
   */
  public Prompt getPrompt() { return (Prompt)(_getFeatureValueNc(wrapGetIntCatchException(_FH_prompt)));}
   ...
   * @return value of the feature 
   */
  public Message getMessage() { return (Message)(_getFeatureValueNc(wrapGetIntCatchException(_FH_message)));}
