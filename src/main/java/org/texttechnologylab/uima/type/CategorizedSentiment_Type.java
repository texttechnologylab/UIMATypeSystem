...
public class CategorizedSentiment_Type extends Sentiment_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("org.texttechnologylab.uima.type.CategorizedSentiment");
  ...
  public double getPos(int addr) {
      ...
      jcas.throwFeatMissing("pos", "org.texttechnologylab.uima.type.CategorizedSentiment");
  ...
  public double getNeu(int addr) {
      ...
      jcas.throwFeatMissing("neu", "org.texttechnologylab.uima.type.CategorizedSentiment");
  ...
  public double getNeg(int addr) {
      ...
      jcas.throwFeatMissing("neg", "org.texttechnologylab.uima.type.CategorizedSentiment");
