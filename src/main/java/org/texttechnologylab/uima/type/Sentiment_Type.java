 ...
 * @generated */
public class Sentiment_Type extends Classification_Type {
  /** @generated */
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("org.texttechnologylab.uima.type.Sentiment");
  ...
  public double getSentiment(int addr) {
      ...
      jcas.throwFeatMissing("sentiment", "org.texttechnologylab.uima.type.Sentiment");
  ...
  public double getSubjectivity(int addr) {
      ...
      jcas.throwFeatMissing("subjectivity", "org.texttechnologylab.uima.type.Sentiment");
